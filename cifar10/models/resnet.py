...
__all__ = ['ResNet', 'PreAct_ResNet', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110', 'resnet164',
           'resnet1001', 'resnet1202', 'preact_resnet20', 'preact_resnet110', 'preact_resnet164', 'preact_resnet1001']
...
def preact_resnet20(**kwargs):
    model = PreAct_ResNet(PreActBasicBlock, [3, 3, 3], **kwargs)
    return model
